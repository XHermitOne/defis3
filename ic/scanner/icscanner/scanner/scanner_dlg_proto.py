...
class icScannerDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.option_notebook.AddPage( self.option_panel, u"Параметры сканирования", False )
		...
		self.option_notebook.AddPage( self.extend_panel, u"Дополнительно", True )
...
class icLoadSheetsDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Загрузка листов в лоток", pos = wx.DefaultPosition, size = wx.Size( 653,181 ), style = wx.DEFAULT_DIALOG_STYLE|wx.STAY_ON_TOP )
...
class icVerifyScanDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Проверка результата сканирования", pos = wx.DefaultPosition, size = wx.Size( 943,120 ), style = wx.DEFAULT_DIALOG_STYLE|wx.STAY_ON_TOP )
