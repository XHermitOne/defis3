...
class icPrjModules(prj_node.icPrjFolder):
    ...
    def isPackage(self, directory):
        ...
        is_init_file = False
        if is_dir:
            is_in_prj = filefunc.isSubDir(directory, os.path.dirname(self.getRoot().getPrjFileName()))
...
class icPrjPackage(prj_node.icPrjFolder):
    ...
    def getPath(self, cur_path=None):
        ...
        if issubclass(self._Parent.__class__, icPrjPackage):
            ...
            cur_path = filefunc.get_absolute_path(os.path.join('.', self.getRoot().name, cur_path),
    ...
    def cut(self):
        ...
        filefunc.copyFile(py_file, copy_py_file)
...
class icPrjModule(prj_node.icPrjNode):
    ...
    def delete(self):
        ...
        if res_file_name and filefunc.isSamePathWin(module_name, res_file_name):
        ...
        if os.path.exists(module_name):
            ...
            filefunc.createBAKFile(module_name)
