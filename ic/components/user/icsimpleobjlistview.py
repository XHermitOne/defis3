...
#   Имя класса
ic_class_name = 'icSimpleObjectListView'

#   Описание стилей компонента
ic_class_styles = {'DEFAULT': 0}

# Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'SimpleObjectListView',
                'name': 'default',
                'description': None,
                'child': [],
                'activate': True,
...
class icSimpleObjectListView(icwidget.icWidget, parentModule.ObjectListView):
    """
    Простой список объектов.
    ...
    def __init__(self, parent, id=-1, component=None, logType=0, evalSpace=None,
        ...
        parentModule.ObjectListView.__init__(self, parent, id,
                                             style=style,
    ...
    def setColumnsSpc(self, *Columns_):
        ...
        for column in Columns_:
            activate = column.get('activate', True)
            if not activate:
