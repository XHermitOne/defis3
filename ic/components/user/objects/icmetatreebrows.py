...
class MetaTreeBrows(icobjectinterface.icObjectInterface):
    ...
    ###BEGIN EVENT BLOCK
    def activatedFuncplansTreeCtrl(self, event):
        """
        Функция обрабатывает событие <activated>.
        """
        return None
    
    def selectedFuncplansTreeCtrl(self, event):
        """
    ...
    def OnCloseFuncplanPanel(self, event):
        """
