...
Класс пользовательского компонента, описывающего дополнительные обработчики событий.
...
# --- Спецификация ---
SPC_IC_WX_BINDER = {'type': 'WX_Binder',
                    'name': 'default',
                    'child': [],

                    '__attr_types__': {0: ['name', 'type'],
                                       icDefInf.EDT_USER_PROPERTY: ['src', 'receiver'],
                                       },
...
ic_class_doc = 'ic/doc/_build/html/ic.components.user.ic_wx_binder.html'
ic_class_spc['__doc__'] = ic_class_doc
                    
#   Список компонентов, которые могут содержаться в компоненте
ic_can_contain = ['WX_SignalType']
...
class icWX_Binder(icwidget.icSimple):
    """
