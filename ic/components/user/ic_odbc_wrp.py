...
"""
Класс пользовательского компонента БД ODBC.
...
import ic.db.icODBC as ic_odbc

#   Тип компонента
ic_class_type = icDefInf._icDatasetType

#   Имя класса
ic_class_name = 'icODBCDataSource'

#   Описание стилей компонента
ic_class_styles = {'DEFAULT': 0}

#   Спецификация на ресурсное описание класса
ic_class_spc = {'type': ic_odbc.ODBC_DATASOURCE_TYPE,
                'name': 'default', 
                'activate': True,
                'init_expr': None,
                '_uuid': None,
                ...
                '__parent__': ic_odbc.SPC_IC_ODBC,
                }
...
ic_class_doc = 'ic/doc/ic.components.user.ic_odbc_wrp.icODBCDataSource-class.html'
