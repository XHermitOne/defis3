...
# --- Спецификация ---
SPC_IC_POSTFUNCSIGNAL = {'class_name': None,    # Имя класса объекта-источника
                         ...
                         'func_name': None,     # Имя функции объекта
                         ...
                         '__attr_hlp__': {'class_name': u'Имя класса объекта-источника',
                                          ...
                                          'func_name': u'Имя функции объекта',
                                          },
                         }
...
#   Имя класса
ic_class_name = 'icPostFuncSignal'

#   Описание стилей компонента
ic_class_styles = None

#   Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'PostFuncSignal',
                'name': 'default',
                'child': [],
                'activate': True,
                'init_expr': None,
                ...
                '__attr_types__': {icDefInf.EDT_TEXTFIELD: ['name', 'type',
                                                            'class_name', 'obj_name',
                                                            'res_name', 'sub_sys', 'func_name'],
                                   icDefInf.EDT_TEXTLIST: ['args'],
                                   },

                '__parent__': SPC_IC_POSTFUNCSIGNAL,
                }
...
class icPostFuncSignal(icwidget.icSimple, parentModule.icPostFuncSrc):
    """
    ...
    def __init__(self, parent, id, component, logType=0, evalSpace=None,
        ...
        parentModule.icPostFuncSrc.__init__(self, pasport, self.eval_attr('func_name'))
