...
# --- Спецификация ---
SPC_IC_WXSIGNAL = {'class_name': None,  # Имя класса объекта-источника
                   ...
                   'wx_event': None,    # Указание события WX
                   ...
                   '__attr_hlp__': {'class_name': u'Имя класса объекта-источника',
                                    ...
                                    'wx_event': u'Указание события WX',
                                    },
                   }
...
#   Имя класса
ic_class_name = 'icWxSignal'

#   Описание стилей компонента
ic_class_styles = None

#   Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'WxSignal',
                'name': 'default',
                'child': [],
                'activate': True,
                'init_expr': None,
...
class icWxSignal(icwidget.icSimple, parentModule.icWxEvtSignalSrc):
    ...
    def __init__(self, parent, id, component, logType=0, evalSpace=None,
        ...
        passport = icobject.icObjectPassport((self.class_name, self.obj_name, self.interface,
                                              self.res_name, self.sub_sys))
