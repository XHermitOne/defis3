...
class %s(ictemplate.icTemplateInterface):
    ...
    def __init__(self, parent, id=-1, component=None, logType=0, eval_space=None, bCounter=False, progressDlg=None):
        \"\"\"
        Interface constructor.
        \"\"\"
        # Append for specification
        component = util.icSpcDefStruct(ic_class_spc, component)
        ictemplate.icTemplateInterface.__init__(self, parent, id, component, logType, eval_space,
...
class %s(parentClass):
    ...
    def __init__(self, parent, id=-1, component=None, logType=0, eval_space=None, bCounter=False, progressDlg=None):
        ...
        # Append for specification
        component = util.icSpcDefStruct(ic_class_spc, component)
        parentClass.__init__(self, parent, id, component, logType, eval_space,
                             bCounter, progressDlg)
