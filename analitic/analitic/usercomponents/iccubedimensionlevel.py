...
ic_class_pic = ic_bmp.createLibraryBitmap('node-select-child.png')
ic_class_pic2 = ic_bmp.createLibraryBitmap('node-select-child.png')
...
def get_user_property_editor(attr, value, pos, size, style, propEdt, *arg, **kwarg):
    ...
    if attr in ('key', 'label_attribute'):
        ...
        result = ic_dlg.icSingleChoiceDlg(parent=None, title=u'Аттрибуты',
