...
class icCubesPivotTabRequestPanelProto ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 861,721 ), style = wx.TAB_TRAVERSAL )
		
		bSizer13 = wx.BoxSizer( wx.VERTICAL )
		
		bSizer14 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText6 = wx.StaticText( self, wx.ID_ANY, u"Куб:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText6.Wrap( -1 )
		...
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Сводная таблица:" ), wx.VERTICAL )
		
		bSizer16 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText7 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Строки", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText7.Wrap( -1 )
		...
		self.m_staticText9 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"до Уровня:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText71 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Колонки", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText91 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"до Уровня:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		sbSizer2 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Вычисления:" ), wx.VERTICAL )
		...
		sbSizer3 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Срезы:" ), wx.VERTICAL )
		
		bSizer20 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText16 = wx.StaticText( sbSizer3.GetStaticBox(), wx.ID_ANY, u"Срез", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText18 = wx.StaticText( sbSizer3.GetStaticBox(), wx.ID_ANY, u"Значения:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.cut_help_bpButton = wx.BitmapButton( sbSizer3.GetStaticBox(), wx.ID_ANY, wx.ArtProvider.GetBitmap( wx.ART_HELP, wx.ART_TOOLBAR ), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
