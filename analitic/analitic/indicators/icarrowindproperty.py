...
#        ind.majorValues = range(min_value, max_value+1)[0::majorStep]
#        ind.minorValues = range(min_value, max_value+1)[0::minorStep]
#        ind.majorLabels = ind.majorValues
#        ind.factor = factor
