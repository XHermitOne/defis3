...
#                                treeLabels=['Мониторы'])
    ...
    obj=brows.getObject()
    print 'showTextMonitorBrowser',obj
    ic_user.icAddMainOrgPage(obj,'Табличные мониторы')
...
#                                treeLabels=['Мониторы'])
    ...
    obj=brows.getObject()
    #obj.Show(True)
    print 'showMonitorBrowser',obj
    ic_user.icAddMainOrgPage(obj,'Просмотр индикаторов')
