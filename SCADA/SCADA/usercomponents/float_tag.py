...
ic_class_pic = bmpfunc.createLibraryBitmap('tag_purple.png')
ic_class_pic2 = bmpfunc.createLibraryBitmap('tag_purple.png')

#   Путь до файла документации
ic_class_doc = 'SCADA/doc/_build/html/SCADA.usercomponents.float_tag.html'
...
class icFloatSCADATag(scada_tag.icSCADATagProto, icwidget.icSimple):
    """
    Компонент вещественного тега SCADA системы.
