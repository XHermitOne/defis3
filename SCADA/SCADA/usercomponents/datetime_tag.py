...
ic_class_pic = bmpfunc.createLibraryBitmap('tag_orange.png')
ic_class_pic2 = bmpfunc.createLibraryBitmap('tag_orange.png')

#   Путь до файла документации
ic_class_doc = 'SCADA/doc/_build/html/SCADA.usercomponents.datetime_tag.html'
...
class icDateTimeSCADATag(scada_tag.icSCADATagProto, icwidget.icSimple):
    """
    Компонент временного тега SCADA системы.
