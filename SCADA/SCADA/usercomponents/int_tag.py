...
ic_class_pic = bmpfunc.createLibraryBitmap('tag_blue.png')
ic_class_pic2 = bmpfunc.createLibraryBitmap('tag_blue.png')

#   Путь до файла документации
ic_class_doc = 'SCADA/doc/_build/html/SCADA.usercomponents.int_tag.html'
...
class icIntSCADATag(scada_tag.icSCADATagProto, icwidget.icSimple):
    """
    Компонент целочисленного тега SCADA системы.
