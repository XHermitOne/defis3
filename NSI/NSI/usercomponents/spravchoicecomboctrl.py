...
"""
Контрол выбора элемента справочника в стандартном виде
...
import NSI.nsi_sys.icspravchoicecomboctrl as parentModule
...
#   Имя класса
ic_class_name = 'icSpravChoiceComboCtrl'

#   Описание стилей компонента
ic_class_styles = ICComboCtrlStyle

# Спецификация на ресурсное описание класса
ic_class_spc = {'type': 'SpravChoiceComboCtrl',
                'name': 'default',
                'activate': True,
                'init_expr': None,
                '_uuid': None,
...
ic_class_doc = 'NSI/doc/_build/html/NSI.usercomponents.spravchoicecomboctrl.html'
...
class icSpravChoiceComboCtrl(parentModule.icSpravChoiceComboCtrlProto, icwidget.icWidget):
    """
    ...
    def __init__(self, parent, id, component, logType=0, evalSpace=None,
        ...
        parentModule.icSpravChoiceComboCtrlProto.__init__(self, parent, id,
