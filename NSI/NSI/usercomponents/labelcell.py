...
# import NSI.nsi_img as nsi_img

### Описание цветовых схем
blue_scheme = {'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.blue2Bgr,
               'foregroundColor': (255, 255, 255),
               'backgroundColor': (164, 209, 255)}

light_blue_scheme = {'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.blueBgr,
...
red_scheme = {'backgroundColor': (128, 0, 45),
              ...
              'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.redBgr,
...
green_scheme = {'backgroundColor': (56, 112, 94),
                ...
                'foregroundColor': (255, 255, 255),
                'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.greenBgr,
...
gray_scheme = {'backgroundColor': (178, 178, 178),
               ...
               'foregroundColor': (0, 0, 0),
               'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.gray2Bgr,
...
flat_gray_scheme = {'backgroundColor': (178, 178, 178),
                    'backgroundColor2': (245, 245, 245),
                    'foregroundColor': (0, 0, 0),
                    'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.indBgrPic3,
                    'borderBottomColor': (150, 150, 150),
                    'borderTopColor': (150, 150, 150),
                    'borderLeftColor': (150, 150, 150),
                    'borderRightColor': (150, 150, 150)}
...
white_scheme = {'backgroundColor': (209, 228, 248),
                ...
                'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.whiteBlueBgr,
...
gold_scheme = {'backgroundColor': (249, 164, 6),
               ...
               'foregroundColor': (0, 0, 0),
               'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.lightGoldBgr,
...
black_scheme = {'backgroundColor': (30, 30, 30),
                ...
                'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.blackBgr,
...
lightBrown_scheme = {'backgroundColor': (223, 223, 189),
                     ...
                     'foregroundColor': (0, 0, 0),
                     'bgrImage': bmpfunc.createLibraryBitmap('picture.png'),  #nsi_img.lightBrownBgr,
        ...
        if context:
            ...
            for cell in self._reg_objects.values():
                if cell.type == 'HeadCell':
                    ...
                    self.resource['label'] = self.label
