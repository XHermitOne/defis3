...
"""
Грид выбора справочника. Упрощенная версия.
Оригинальная версия - XPSpravTable
"""
### TEMPLATE_MODULE:
...
class icSpravTable(parentClass):
    """
    ...
    def UpdateDataView(self):
        ...
        """
        #   Если размер грида не совпадает с размерами данных,
        # то подстраиваем размер грида
        try:
...
class icHugeTable(gridlib.PyGridTableBase):
