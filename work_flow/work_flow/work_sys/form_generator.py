...
class icObjFormGenerator:
    ...
    def _genChoicePanelRes(self, name=None):
        ...
        # Модуль ресурса
        res_module_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'),
                                                                       spc['res_module']))
        if os.path.exists(res_module_file_name):
            os.remove(res_module_file_name)
        form_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'), name + '.frm'))
    ...
    def _genChoiceDialogRes(self, name=None):
        ...
        # Модуль ресурса
        res_module_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'), frm_spc['res_module']))
        if os.path.exists(res_module_file_name):
            os.remove(res_module_file_name)
        form_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'), name + '.frm'))
        txt = frm_gen_templates._choiceDlgResModuleFmt % (form_file_name, '### RESOURCE_MODULE',
    ...
    def _genInitDialogRes(self, FormName_=None):
        ...
        if os.path.exists(res_module_file_name):
            os.remove(res_module_file_name)
        form_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'), FormName_ + '.frm'))
    ...
    def _genEditDialogRes(self, FormName_=None):
        ...
        if os.path.exists(res_module_file_name):
            os.remove(res_module_file_name)
        form_file_name = filefunc.get_absolute_path(os.path.join(glob_functions.getVar('PRJ_DIR'), FormName_ + '_dlg.frm'))
