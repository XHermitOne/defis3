...
ic_class_spc = dict({'type': 'DocumentFilterManager',
                     'name': 'default',
                     'child': [],
                     'activate': True,
                     'init_expr': None,
...
ic_class_pic = ic_bmp.createLibraryBitmap('ic_box_doc_filter.png')
ic_class_pic2 = ic_bmp.createLibraryBitmap('ic_box_doc_filter.png')
