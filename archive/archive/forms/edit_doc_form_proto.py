...
class icEditDocPanelProto ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 1150,778 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.scan_bpButton = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.scan_bpButton.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_NORMAL_FILE, wx.ART_MESSAGE_BOX ) )
		...
		self.docname_textCtrl = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_ENTER )
...
class icPackScanDocPanelProto ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 1185,300 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		wx.Panel.__init__ ( self, parent, id = id, pos = pos, size = size, style = style, name = name )
		...
		self.clear_doc_type_bpButton = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.clear_doc_type_bpButton.SetBitmap( wx.ArtProvider.GetBitmap( u"gtk-clear", wx.ART_MENU ) )
		...
		self.clear_contragent_bpButton = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.clear_contragent_bpButton.SetBitmap( wx.ArtProvider.GetBitmap( u"gtk-clear", wx.ART_MENU ) )
