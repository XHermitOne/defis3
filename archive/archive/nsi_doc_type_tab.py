...
"""
Resource module </mnt/defis/defis3/archive/archive/nsi_doc_type.tab>
File            </mnt/defis/defis3/archive/archive/nsi_doc_type_tab.py>
...
SPRAV_DBF_FILENAME = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'db', 'SPRAV.DBF') if os.path.dirname(__file__) else  '/mnt/defis/defis3/archive/db/SPRAV.DBF'
...
DOC_TYPE_DEFAULT_DATA = [('100', u'Приходные документы'),
                         ...
                         ('1009200000000', u'Приход. Универсальный передаточный документ2'),
                         ...
                         ('2009200000000', u'Расход. Универсальный передаточный документ2'),
                         ...
                         ('9009700000000', u'Соглашение о зачете требований'),
                         ('9009800000000', u'Декларация'),
                         ('9009900000000', u'Инвойс'),
                         ]
