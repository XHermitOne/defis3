...
"""
Resource module </mnt/defis/defis/ayan_archive/ayan_archive/nsi_c_agent.tab>
File            </mnt/defis/defis/ayan_archive/ayan_archive/nsi_c_agent_tab.py>
...
### RESOURCE_MODULE: /mnt/defis/defis/ayan_archive/ayan_archive/nsi_c_agent.tab
...
SPRAV_DBF_FILENAME = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'db', 'SPRVENT.DBF') if os.path.dirname(__file__) else  '/mnt/defis/defis/ayan_archive/db/SPRVENT.DBF'
