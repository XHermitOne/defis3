...
###########################################################################
## Class icIndicatorConstructorDlgProto
###########################################################################

class icIndicatorConstructorDlgProto ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Индикатор фильтра", pos = wx.DefaultPosition, size = wx.Size( 776,724 ), style = wx.DEFAULT_DIALOG_STYLE )
