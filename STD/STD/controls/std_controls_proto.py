...
class icDateTimeCtrlProtoDepricate ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.dateEdit = wx.adv.DatePickerCtrl( self, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_ALLOWNONE|wx.adv.DP_DEFAULT )
...
class icDateTimeCtrlProto ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.dateEdit = wx.adv.DatePickerCtrl( sbSizer1.GetStaticBox(), wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_ALLOWNONE|wx.adv.DP_DEFAULT )
